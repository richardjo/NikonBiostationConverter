    ...
    for file in image_file_list:
        ...
        if use_output_directory == True:
            if use_stitching == True:
                ...
                output_tiff_path = str(output_directory / time_directory / Path(stiching_file_name).with_suffix(".ome.tiff"))
                convert(input_image_path, output_tiff_path, bf_tools_directory)
                xml_path = str(output_directory / time_directory / Path(stiching_file_name).with_suffix(".xml"))
            else: 
